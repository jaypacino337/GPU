    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-2 max-w-prose text-sm text-muted">
          One random unminted PumpBroker per mint. You can sell it back to the
      ...
      {phase === "done" && minted && (
        <div className="panel-neon p-5">
          <p className="font-display text-sm text-neon">You got a PumpBroker</p>
      ...
      <ConfirmDialog
        ...
        body={
          <>
            You will receive one random unminted PumpBroker, plus roughly 0.003 SOL
