...
- **Mint** — 1,000,000 $PUMPBROKER → one random unminted PumpBroker
- **Sell back** — return any PumpBroker → 950,000 $PUMPBROKER (95%, the floor)
...
- Redemption only accepts assets whose Core update authority **is our
  collection**. Anyone can create an asset named "PumpBroker #7"; only ours are
