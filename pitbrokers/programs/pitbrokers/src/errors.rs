...
pub enum PitBrokersError {
    ...
    #[msg("All 1000 PitBrokers have been minted.")]
    SoldOut,
    ...
    #[msg("That PitBroker does not belong to this collection.")]
    WrongCollection,

    #[msg("That asset is not held by the vault, so it cannot be minted.")]
    AssetNotInVault,

    #[msg("You do not own that PitBroker.")]
    NotAssetOwner,
    ...
    #[msg("No unminted PitBrokers remain in the pool.")]
    PoolExhausted,
