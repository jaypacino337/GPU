...
export const metadata = { title: "Docs — PitBrokers" };
    ...
    <div className="max-w-prose space-y-10">
      ...
      <Section title="Minting">
        <p>
          ...
          receive one random unminted PitBroker. There are exactly {SUPPLY_CAP},
      ...
      <Section title="Selling back">
        <p>
          Return any PitBroker to the program and receive{" "}
